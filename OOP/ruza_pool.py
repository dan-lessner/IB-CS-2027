...
def check_game_over():
    ...
    if len(balls) == 1 and balls[0].color == "white":
        game_over = True
        show_game_over()
    ...
    colors = ["red", "yellow", "blue", "green", "purple", "white", "cyan"]
    color = random.choice(colors)

    canvas.itemconfig(game_over_text, fill=color)
    ...
    root.after(300, blink_game_over)
