// CurveFitEA — internacionalizace (i18n): překlad rozhraní beze změny
// zdrojového kódu. (Stejný mechanismus jako EvoMice, viz EvoMice spec 8.2.)
//
...
//                           řádek, popisek zvýrazněné křivky...)
...
var LANGUAGE_STORAGE_KEY = 'curvefitea-language';
...
// text tlačítka start/pauza, popisek zvýrazněné křivky) — si po zavolání
// téhle funkce obnoví main.js samo přes volitelný hook onLanguageChanged(),
// pokud je v danou chvíli definovaný (main.js se načítá až po tomhle souboru).
